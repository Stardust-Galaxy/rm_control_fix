...
#ifndef RM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define RM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // RM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
